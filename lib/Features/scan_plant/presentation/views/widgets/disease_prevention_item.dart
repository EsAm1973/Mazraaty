...
class PreventionItem extends StatefulWidget {
  final String title;
  ...
  @override
  _PreventionItemState createState() => _PreventionItemState();
}

class _PreventionItemState extends State<PreventionItem>
