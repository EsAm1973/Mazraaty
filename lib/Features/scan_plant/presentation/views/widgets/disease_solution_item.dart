...
class DiseaseSoluationsItem extends StatefulWidget {
  final String title;
  ...
  @override
  _DiseaseSoluationsItemState createState() => _DiseaseSoluationsItemState();
}

class _DiseaseSoluationsItemState extends State<DiseaseSoluationsItem>
