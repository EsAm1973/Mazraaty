...
class DiseaseDetailsCubit extends Cubit<DiseaseDetailsState> {
  DiseaseDetailsCubit(this.diseaseRepository) : super(DiseaseDetailsInitial());
  final DiseaseRepository diseaseRepository;

  Future<void> getDiseaseDetails(String diseaseName) async {
    emit(DiseaseDetailLoading());
    final Either<Failure, DiseaseDetailsModel> result =
        await diseaseRepository.fetchDiseaseDetails(diseaseName);
    result.fold(
